<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"  import="com.meiri.jsp.inquiry.model.vo.*, 
                                  com.meiri.jsp.inquiryComment.model.vo.*, java.util.*"%>
	...
	<div class="outer">
		...
		<div class="tableArea">
				<table align="center" width="800px">
					<tr>
						<td>제목 </td>
						<td colspan="5"><span><%= b.getcTitle() %></span></td>
					</tr>
					<tr>
						<td>작성자 </td>
		...
		<div align="center">
			...
			<% if(m != null && m.getUserId().equals(b.getUserId())){ %>
			<button onclick="location.href='<%= request.getContextPath() %>/bUpView.bo?bno='+<%=b.getcCode()%>">수정하기</button>
			<% } %>
		</div>
